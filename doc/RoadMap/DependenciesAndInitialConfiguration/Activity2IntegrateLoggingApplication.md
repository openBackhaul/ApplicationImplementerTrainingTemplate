...
* Create an Issue with the following details , 
  ...
  * **Comment** :
    - [ ] Read [Integrate Logging Application](https://github.com/openBackhaul/ApplicationPattern/blob/PrathibaJee/issue256/doc/ImplementingApplications/ImplementingApplication/Steps2IntegrateLoggingApplication/Steps2IntegrateLoggingApplication.md)
