...
* Create an Issue with the following details , 
  ...
  * **Comment** :
    - [ ] Read [Implementing OAM services](https://github.com/openBackhaul/ApplicationPattern/blob/PrathibaJee/issue256/doc/ImplementingApplications/ImplementingApplication/Steps2ImplementOAMServices/Steps2ImplementOAMServices.md)
