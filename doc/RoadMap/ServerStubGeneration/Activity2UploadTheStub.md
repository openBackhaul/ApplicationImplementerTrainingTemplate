# Activity : Upload the generated stub to the Repository
...
* Create an Issue with the following tasks , 
  * To the server folder in the repository , upload the content generated in the server side stub from the [activity](./Activity2GenerateServerSideStub.md)
  * Close the issue 
